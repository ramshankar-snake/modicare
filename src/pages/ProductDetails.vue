                ...
                <div class="pdt-main-images col-12 col-md-6">
                    ...
                    <div class="pdt-main-gallery-top swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide pdt-main-gallery-top-item p-0">
                    ...
                    <div class="pdt-main-gallery-thumbs swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pdt-main-gallery-thumbs-item">
                                <img src="@/assets/images/products/products-face-1.png" alt="" />
                            </div>
                            <div class="swiper-slide pdt-main-gallery-top-item swiper-slide-video-thumbnail">
                                <img src="@/assets/images/products/products-face-1.png" alt="" />
                            </div>
                            <div class="swiper-slide pdt-main-gallery-thumbs-item">
                                <img src="@/assets/images/products/products-face-2.png" alt="" />
            ...
            <div class="modi-accordion modi-accordion__equal-spacing">
                <div class="modi-accordion-section">
                    <div class="modi-accordion-section-title-container">
                        <button class="modi-accordion-section-title waves-effect waves-light" data-toggle="collapse" data-target="#modi-accordion-section-1">
                            Product Info
                        </button>
                    </div>
                            ...
                            <div class="pdt-main-benefit-items-container">
                                <div class="pdt-main-benefit-item">
                                    <div class="pdt-main-benefit-item-icon-container">
                                        <img class="pdt-main-benefit-item-icon" src='@/assets/images/products/tree-icon.png'>
                                    </div>
                                    <p class="pdt-main-benefit-item-text">20%<br>less plastic</p>
                                </div>
                                <div class="pdt-main-benefit-item">
                                    <div class="pdt-main-benefit-item-icon-container">
                                        <img class="pdt-main-benefit-item-icon" src='@/assets/images/products/tested-icon.png'>
                                    </div>
                                    <p class="pdt-main-benefit-item-text">Dermatologically<br>tested</p>
                                </div>
                                <div class="pdt-main-benefit-item">
                                    <div class="pdt-main-benefit-item-icon-container">
                                        <img class="pdt-main-benefit-item-icon" src='@/assets/images/products/leaves-icon.png'>
                                    </div>
                                    <p class="pdt-main-benefit-item-text">Sulphate<br>free</p>
                                </div>
                                <div class="pdt-main-benefit-item">
                                    <div class="pdt-main-benefit-item-icon-container">
                                        <img class="pdt-main-benefit-item-icon" src='@/assets/images/products/drop-icon.png'>
                                    </div>
                                    <p class="pdt-main-benefit-item-text">Skin<br>gentle</p>
                                </div>
                                <div class="pdt-main-benefit-item">
                                    <div class="pdt-main-benefit-item-icon-container">
                                        <img class="pdt-main-benefit-item-icon" src='@/assets/images/products/earth-icon.png'>
                                    </div>
                                    <p class="pdt-main-benefit-item-text">100%<br>natural</p>
                                </div>
                                <div class="pdt-main-benefit-item">
                                    <div class="pdt-main-benefit-item-icon-container">
                                        <img class="pdt-main-benefit-item-icon" src='@/assets/images/products/windmill-icon.png'>
                                    </div>
                ...
                <div class="modi-accordion-section">
                    <div class="modi-accordion-section-title-container">
                        <button class="modi-accordion-section-title waves-effect waves-light collapsed" data-toggle="collapse" data-target="#modi-accordion-section-2">
                            Features & Benefits
                        </button>
                    </div>
                ...
                <div class="modi-accordion-section">
                    <div class="modi-accordion-section-title-container">
                        <button class="modi-accordion-section-title waves-effect waves-light collapsed" data-toggle="collapse"
                ...
                <div class="modi-accordion-section">
                    <div class="modi-accordion-section-title-container">
                        <button class="modi-accordion-section-title waves-effect waves-light collapsed" data-toggle="collapse"
                                data-target="#modi-accordion-section-4">
                            Applications
                        </button>
                    </div>
                ...
                <div class="modi-accordion-section">
                    <div class="modi-accordion-section-title-container">
                        <button class="modi-accordion-section-title waves-effect waves-light collapsed" data-toggle="collapse"
                                data-target="#modi-accordion-section-5">
                            Details
                        </button>
                    </div>
                ...
                <div class="modi-accordion-section">
                    <div class="modi-accordion-section-title-container">
                        <button class="modi-accordion-section-title waves-effect waves-light collapsed" data-toggle="collapse"
                                data-target="#modi-accordion-section-6">
                            Other Info
                        </button>
                    </div>
