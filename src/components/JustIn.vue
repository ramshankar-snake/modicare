<template>
    ...
    <div class="products-showcase-introduction">
        ...
        <div class="products-showcase-content">
            <p> Check out some of our newly launched products, you'll them all!</p>
        </div>
                        ...
                        <div class="listing-item">
                            <div class="listing-item-link">
                                <div class="listing-item-inner">
                                    ...
                                    <div class="listing-item-description-container">
                                        <router-link :to="'/product/details/' + product.productId" class="listing-item-description">{{  product.productName }}</router-link>
                            ...
                            <div class="listing-item-footer-container">
                                ...
                                <div class="listing-item-add-to-bag">
                                    <a href="javascript:;" class="listing-item-add-to-bag-link btn modi-btn modi-btn__sm px-3 modi-btn__primary" data-toggle="modal" data-target="#modi-add-to-cart-without-login-modal">Add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    async mounted(){
            ...
            if(result.status==200) {
                ...
                this.products = result.data.result.justIn;
