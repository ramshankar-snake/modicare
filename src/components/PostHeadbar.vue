          ...
          <div class="modi-container nav-container">
              <div class="nav-links">
                  <div class="nav-links-desktop">
                      <router-link to='/post/Career'  class="nav-link logo-link" href="@/index.html">
                          ...
                          <div class="nav-dropdown about-menu-dropdown">
                              <div class="nav-dropdown-list">
                                  <div class="nav-dropdown-item">
                                      <router-link to="/post/our-story" class="nav-dropdown-item-link">Our Story</router-link>
                                  </div>
                                  <div class="nav-dropdown-item">
                                      <router-link to="/post/the-visionary" class="nav-dropdown-item-link">The Visionary</router-link>
                                  </div>
                                  <div class="nav-dropdown-item-separator"></div>
                                  <div class="nav-dropdown-item">
                                      <router-link to="/post/achievers" class="nav-dropdown-item-link">Success Stories</router-link>
                                  </div>
                                  <div class="nav-dropdown-item">
                                      <router-link to="/post/events" class="nav-dropdown-item-link">Events</router-link>
                                  </div>
                                  <div class="nav-dropdown-item">
                                      <router-link to='/post/Career'  class="nav-dropdown-item-link">Careers</router-link>
                                  </div>
                              </div>
                          </div>
                      </div>
                      <router-link to='/post/Career'  class="nav-link" >Offers</router-link>
                      <router-link class="nav-link" to="/post/contact-us">Start Your Business</router-link>
